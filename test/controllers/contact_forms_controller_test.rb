...
class ContactFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post contact_forms_url, params: { contact_form: { body: @contact_form.body, email: @contact_form.email, name: @contact_form.name, title: @contact_form.title } }
    end
  ...
  test "should update contact_form" do
    patch contact_form_url(@contact_form), params: { contact_form: { body: @contact_form.body, email: @contact_form.email, name: @contact_form.name, title: @contact_form.title } }
